...
*/ -}}
{{- define "eric-oss-file-notification-enm-stub.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-file-notification-enm-stub.mergeAnnotations" -}}
  {{- include "eric-oss-file-notification-enm-stub.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-file-notification-enm-stub.mergeLabels" -}}
  {{- include "eric-oss-file-notification-enm-stub.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}